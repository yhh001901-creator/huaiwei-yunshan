            ...
            >
              ...
              <div class="p-3">
                ...
                <div class="flex justify-between items-center mt-2">
                  <span class="text-teal-600 font-bold">¥{{ dish.price }}</span>
                  <button
                    v-if="dish.status === 1"
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 h-fit sticky top-8">
          ...
          <div class="space-y-3 max-h-80 overflow-y-auto">
            ...
            >
              ...
              <span class="text-teal-600 font-bold">¥{{ (item.price * item.quantity).toFixed(2) }}</span>
            </div>
          </div>
          ...
          <div class="mt-4 pt-4 border-t border-slate-200">
            <div class="flex justify-between items-center text-lg font-bold mb-4">
              <span>总计</span>
              <span class="text-teal-600">¥{{ totalPrice.toFixed(2) }}</span>
            </div>
            <button
              @click="checkout"
